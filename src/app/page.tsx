...
export default function Home() {
  return (
    <div className="relative overflow-hidden">
      ...
      {/* Server Status Dedicated Section */}
      <section className="py-24 px-6 bg-navy-default/50">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center mb-16">
             ...
             <h2 className="text-sm font-oswald text-primary-gold uppercase tracking-[0.5em] mb-4">Live Monitoring</h2>
             <h3 className="text-4xl md:text-5xl font-oswald font-bold text-white uppercase tracking-tight">Server Infrastructure</h3>
          </div>
