  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      >
        ...
        {copied && (
          <motion.div
            ...
            className="absolute -top-10 left-1/2 -translate-x-1/2 bg-green-500 text-white text-xs font-bold px-3 py-1 rounded shadow-lg"
          >
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-foreground/70 uppercase tracking-widest font-oswald">243 Players Online</span>
      </div>
    </div>
  );
};
